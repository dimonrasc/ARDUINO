...
#define CLK 3
#define DIO 2
#define outputRelayBrow 9
#define outputRealyBlue 8
#define tempHigh 30;
#define tempLow 25;
...
#include "max6675.h"
#include "DHT.h"
#define DHTPIN 12     // к какому пину будет подключен вывод Data
...
*/
   ...
   else if(thermocouple.readCelsius() < 154){
    //on relay
    disp.point(false);
