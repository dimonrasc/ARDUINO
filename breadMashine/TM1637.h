...
/*	Текущая версия: 1.1 от 26.09.2018
	  TM1637 - бибилотека для 7 сегментного дисплея на чипе TM1637
...
class TM1637
{
  public:
    ...
    TM1637(uint8_t clk, uint8_t dio);						// объявление и инициализация
...
#define _u 0x1c
#define _y 0x6e
#define _dash 0x40 //тире
#define _under 0x08 //нижнее подчеркивание
#define _cap 0x01 //верхнее подчеркивание
#define _equal 0x48 //равенство
#define _empty 0x00 //пробел
#define _degree 0x63 //градус
#define CH 0x66 //русская буква Ч
#define RG 0x31 //русская буква Г
#define Rg 0x31 //русская буква г
#define RE 0x4f //русская буква Э
#define Rd 0x67 //русская буква д
#define RB 0x7d //русская буква Б
#define RZ 0x4f //русская буква З
#define RP 0x37 //русская буква П
